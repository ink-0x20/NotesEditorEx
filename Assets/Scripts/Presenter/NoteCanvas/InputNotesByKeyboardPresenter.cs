...
namespace NoteEditor.Presenter
{
    public class InputNotesByKeyboardPresenter : MonoBehaviour
    {
        ...
        void EnterNote(int block)
        {
            ...
            editPresenter.RequestForEditNote.OnNext(new Note(new NotePosition(EditData.Size.Value, EditData.Special.Value, EditData.LPB.Value, beats, block), EditState.NoteType.Value));
        }
    }
}

                ...
                .Subscribe(_ =>
                {
                    ...
                    if (NoteCanvas.IsMouseOverNotesRegion.Value)
                    {
                        ...
                        if (distance.x < thresholdX && distance.y < thresholdY)
                        {
                            ...
                            NoteCanvas.ClosestNotePosition.Value = new NotePosition(EditData.Size.Value, EditData.Special.Value, EditData.LPB.Value, closestLineIndex, closestBlockLindex);
                        }
                        else
                        {
                    ...
                    if (EditData.LPB.Value * 4 < beatLines.Length)
                    {
